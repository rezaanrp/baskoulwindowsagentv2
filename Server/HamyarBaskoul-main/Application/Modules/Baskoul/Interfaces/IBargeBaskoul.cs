...
namespace Application.Interfaces
{
    public interface IBargeBaskoul
    {
        ...
        Task<bool> AddOrCompleteByPlateAsync(BargeBaskoulViewModel entity);
        ...
        Task<BargeBaskoulViewModel?> GetLatestByPlateAsync(string codeMarkaz, int siteId, string shomareMashin);
        public Task<PagedResultBarge> GetFilteredAsyncbyType(int type, string codeMarkaz, int siteId, string searchTerm,

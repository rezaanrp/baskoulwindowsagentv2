...
{
    public class BuilderProfileCompletedProjectViewModels
    {
        [Key]
        ...
        [MaxLength(15)]
        public string? StartDateFarsi { get; set; } // تاریخ شروع اجرا
        public DateTime EndDate { get; set; } // تاریخ پایان اجرا
        [MaxLength(15)]
        public string? EndDateFarsi { get; set; } // تاریخ پایان اجرا

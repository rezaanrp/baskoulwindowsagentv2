...
jvm.AbstractShapeElement.mergeStyles = function(styles, Coursetyles) {
  var key;

  Coursetyles = Coursetyles || {};
  for (key in Coursetyles) {
    if (Coursetyles[key] === null) {
      delete styles[key];
    } else {
      styles[key] = Coursetyles[key];
    }
  }
}
/**

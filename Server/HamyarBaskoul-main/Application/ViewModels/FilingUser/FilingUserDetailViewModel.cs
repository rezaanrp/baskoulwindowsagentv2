...
{
	public class FilingUserDetailViewModel
	{
		public int Id { get; set; }
		[MaxLength(100)]
		public string? Name { get; set; }
		[MaxLength(100)]
		[Required(ErrorMessage = "پر کردن نام خانوادگی اجباری می باشد ")]
		...
		[Required(ErrorMessage = "پر کردن شماره همراه اجباری می باشد ")]

		public string Mobile { get; set; }

		[MaxLength(11, ErrorMessage = "فرمت شماره تلفن اشتباه است ")]
		[RegularExpression(@"^[0-9]*$", ErrorMessage = "فرمت شماره تلفن اشتباه است ")]
		public string? Tel { get; set; }
		[Range(1, 100,ErrorMessage ="عدد باید بین صفر تا صد باشد")]
        ...
        [MaxLength(50)]
		[Required(ErrorMessage ="پر کردن خیابان اصلی اجباری می باشد")]

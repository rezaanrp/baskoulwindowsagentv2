...
namespace Domain.Interfaces
{
    public interface IBargeBaskoulRepository
    {
        ...
        Task<BargeBaskoulDomainViewModel?> GetLatestByPlateAsync(string codeMarkaz, int siteId, string shomareMashin);
        ...
        Task<bool> AddOrCompleteByPlateAsync(BargeBaskoulDomainViewModel entity);

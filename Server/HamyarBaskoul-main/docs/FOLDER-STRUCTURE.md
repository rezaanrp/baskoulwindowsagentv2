...
- `Modules/Weighbridge`: همه چیزهایی که مستقیم مربوط به سیستم باسکول است.
...
- `Modules/Weighbridge`: مدل‌ها، view modelهای دامنه و interfaceهای مخصوص باسکول.
...
- `Modules/Weighbridge`: سرویس‌ها، interfaceها، ابزارها و view modelهای مخصوص باسکول.
...
- `Modules/Weighbridge`: repositoryها و کلاس‌های زیرساختی مخصوص باسکول.
- `Migrations`: فقط migrationهای EF Core.

## WebUI

- `Common`: controllerهای پایه، conventionها، view componentها، helperهای upload و view modelهای مشترک UI.
- `Features/Dashboard`: کنترلرهای داشبورد و صفحه اصلی.
- `Features/Identity`: کنترلرهای مدیریت کاربران.
- `Modules/Weighbridge`: کنترلرها و viewهای مخصوص باسکول.
